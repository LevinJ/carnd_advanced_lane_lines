...
src1 = cv.imread('/home/levin/workspace/carnd/carnd_advanced_lane_lines/test_images/test5.jpg')
src2 = cv.imread('/home/levin/workspace/carnd/carnd_advanced_lane_lines/test_images/test4.jpg')
# if src1 is None:
...
cv.createTrackbar(trackbar_name, title_window , 5, alpha_slider_max, on_trackbar)
cv.createTrackbar("test", title_window , 12, 20, on_trackbar)
# Show some stuff
on_trackbar(0)
